...
#define SCLK_PORT		(PA)
#define SCLK_PIN_MASK	(BIT10)
#define SCLK_SET_LOW	(PA10=0)
#define SCLK_SET_HIGH	(PA10=1)

#define SDA_PORT		(PA)
#define SDA_PIN_MASK	(BIT11)
#define SDA_SET_LOW		(PA11=0)
#define SDA_SET_HIGH		(PA11=1)
